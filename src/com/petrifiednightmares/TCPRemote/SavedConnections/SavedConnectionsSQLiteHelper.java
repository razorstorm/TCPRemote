...
public class SavedConnectionsSQLiteHelper extends SQLiteOpenHelper
{
	...
	private static final String CONNECTIONS_TABLE_CREATE = "CREATE TABLE " + CONNECTIONS_TABLE_NAME + " (" + PRIMARY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT , " + CONNECTION_COLUMN_NAME + " TEXT, " + CONNECTION_COLUMN_IP + " TEXT);";
